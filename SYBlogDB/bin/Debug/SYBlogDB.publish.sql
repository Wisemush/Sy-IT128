...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'abf0ea66-803b-4df5-adcc-61b027203164')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('abf0ea66-803b-4df5-adcc-61b027203164')
